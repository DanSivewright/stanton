...
import { CompaniesToolbar } from "@/components/app/CompaniesToolbar";
...
import { findCollection, getCompanyStats } from "@/lib/app/queries";
...
export default async function CompaniesPage({ searchParams }: PageProps) {
  ...
  const { page, limit, query, sort } = parseListParams(params);
