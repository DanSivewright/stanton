...
import { CompanyTabs } from "@/components/mockups/mr/CompanyTabs";
import { DottedRule } from "@/components/mockups/mr/DottedRule";
import * as Avatar from "@/components/ui/avatar";
import * as Breadcrumb from "@/components/ui/breadcrumb";
import * as Button from "@/components/ui/button";
import * as Select from "@/components/ui/select";
import { findById, getCompanyScopedStats } from "@/lib/mockups/queries";
        ...
        <div className="flex flex-1 gap-4 lg:gap-3.5">
          ...
          <Breadcrumb.Root className="w-fit items-center">
            ...
            <Breadcrumb.Item asChild>
              <Link href="/mockups/mr/companies">Companies</Link>
            </Breadcrumb.Item>
            <Breadcrumb.ArrowIcon as={RiArrowRightSLine} />
