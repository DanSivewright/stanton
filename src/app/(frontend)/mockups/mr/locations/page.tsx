...
import { LocationsListView } from "@/components/mockups/mr/LocationsListView";
import { DottedRule } from "@/components/mockups/mr/DottedRule";
import * as Avatar from "@/components/ui/avatar";
import * as Breadcrumb from "@/components/ui/breadcrumb";
import * as Button from "@/components/ui/button";
import * as Select from "@/components/ui/select";
import { buildGlobalLocationListWhere } from "@/lib/mockups/mr/location-filters";
import { getLocationStats } from "@/lib/mockups/queries";
...
export default async function MrLocationsPage({ searchParams }: PageProps) {
      ...
      <div className="px-4 pb-6 lg:px-8">
        ...
        <div className="flex flex-wrap py-6">
          ...
          <div className="w-full border-stroke-soft-200 border-t pt-4 pb-4 first:pl-0 last:pr-0 sm:w-1/2 sm:px-7 sm:pb-0 xl:w-1/4 xl:border-transparent xl:pt-0">
            <div className="text-label-sm text-text-sub-600">Sites</div>
            <div className="mt-1 flex items-center gap-1.5">
              <div className="text-text-strong-950 text-title-h5">
                {stats.sites}
              </div>
