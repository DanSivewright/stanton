...
import { DEFAULT_TICKET_STATUS, TICKET_STATUSES } from '../../lib/constants/ticketStatuses'
...
export const Tickets: CollectionConfig = {
  ...
  admin: {
    useAsTitle: 'title',
    defaultColumns: ['ticketNumber', 'title', 'status', 'reviewStatus', 'priority', 'location'],
  },
  access: {
  ...
  fields: [
    ...
    },
    {
      ...
      label: 'Activity',
      admin: {
        description: 'Chronological log of comments, photos, and lifecycle events.',
      },
      fields: [
        {
          name: 'kind',
