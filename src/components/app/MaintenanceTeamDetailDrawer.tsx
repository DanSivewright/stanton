...
import { formatDate, initials } from "@/lib/app/helpers";
import type { BreakdownItem, TicketSummary } from "@/lib/app/drawer-stats";
import type { TeamDrawerData } from "@/lib/app/team-drawer-types";
...
export function MaintenanceTeamDetailDrawer({
  ...
  useEffect(() => {
    ...
    fetch(
      `/maintenance-teams/${encodeURIComponent(teamId)}/drawer`,
