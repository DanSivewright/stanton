...
} from "@/lib/mockups/mr/ticket-drawer-types";
import { getTicketStatusMeta } from "@/lib/mockups/mr/ticket-status-badge";
...
export function TicketDetailDrawer({
  ...
  useEffect(() => {
    ...
    fetch(`/mockups/mr/tickets/${encodeURIComponent(ticketId)}/drawer`, {
